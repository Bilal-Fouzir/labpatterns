	...
	public PacientSymptomGUI(Observable p) {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		    	...
		    	((Covid19Pacient)p).addSymptomByName(((Symptom)symptomComboBox.getSelectedItem()).getName(),Integer.parseInt(weightField.getText()));
		...
		btnRemoveSymptom.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		    	...
		    	((Covid19Pacient)p).removeSymptomByName(((Symptom)symptomComboBox.getSelectedItem()).getName());
		...
		labelPacient.setText(((Covid19Pacient)p).getName());
